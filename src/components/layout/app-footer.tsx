...
export default function Footer() {
  return (
    <section className="Footer z-20 flex w-full items-center justify-between border-t border-lightPrimary-800/20 bg-white px-4 dark:border-jwdMarine-900/80 dark:bg-jwdMarine-1000">
