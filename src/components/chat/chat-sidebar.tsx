...
export default function ChatSidebar({ userPlan }: ChatSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed bottom-0 left-0 top-0 z-10 flex w-80 max-w-[85vw] flex-col justify-between bg-lightBackground-200 shadow transition-all duration-300 lg:relative lg:w-64 lg:max-w-64 dark:bg-jwdMarine-1000 ${sidebarPosition}`}
      >
